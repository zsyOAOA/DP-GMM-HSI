...
data_path = './data/pure_RemoteImage.mat';
...
switch case_num
    ...
    case 3
        [noi_H, band_deadline]= noise_case3(Ori_H, 20, seed, 1);
    case 4
        [noi_H, band_stripe]= noise_case4(Ori_H, 15, seed, 1);   
    case 5
        [noi_H]= noise_case5(Ori_H, seed);   
    case 6
        [noi_H, band_deadline, band_stripe]= noise_case6(Ori_H, 10, 10, seed);
end
